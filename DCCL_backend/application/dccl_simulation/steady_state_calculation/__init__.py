...
def cal_final_output(matrix_all, aperture_all, data):
    ...
    #部分参数写死
    Iten_out, t, s_it1, s_it2 = steady_state(matrix_all[0], matrix_all[1], aperture_all[1], aperture_all[0], aperture_all[2]*aperture_all[3],
                                            ...
                                            data['resonatorParam']['pumpWatt'],data['resonatorParam']['lamada'] )
